...
**朝**
- **08:37** ツェルマット発 → フィスプ → シュピーツ → インターラーケン・オスト → グリンデルワルト
- **11:40** グリンデルワルト着 (3時間3分)

**午後**
- **12:30** ホテルチェックイン
- **14:00** **ユングフラウヨッホ - ヨーロッパの屋根** 
  - アイガーエクスプレス利用 CHF 168×2 = 336 CHF / 58,800 JPY (パス25%割引)
  - 予約手数料 CHF 10×2 = 20 CHF必須 (5/1-8/31期間)
- **16:00** 氷宮殿・スフィンクス展望台・アルペン・センセーション体験

**夕食**: **Stallbeizli Heuboden** (CHF 80×2 = 160 CHF / 28,000 JPY)
- 伝統的なスイス山小屋、自家製チーズとハム
- グリンデルワルト谷の絶景
...
### Day 6: 6月24日(火) - グリンデルワルト → ベルン

**朝**
- **10:07** グリンデルワルト発 → インターラーケン・オスト経由 → ベルン
- **11:40** ベルン着 (1時間33分)

**午後**
- **12:30** ホテルチェックイン
- **14:00** **ベルン旧市街UNESCO世界遺産観光**
  - 時計台・大聖堂・連邦議事堂
- **15:30** **クマ公園 (ベーレンパーク)** - 無料、3-4頭の熊観察
- **16:30** **バラ公園 (ローゼンガルテン)**
  - 6月はバラ満開、ベルン旧市街パノラマ絶景
  - 無料入場、夕日撮影スポット

**夕食**: **La Terrasse - Bellevue Palace** ガイド・ミヨー16点 (CHF 400×2 = 800 CHF / 140,000 JPY)
- アルプス展望の高級フレンチ、政府迎賓館レストラン
- シャンデリアとパノラマテラス
...
| **小計** | **2,762** | **483,350** | |
| **宿泊費** | | | |
| 7泊 (高級ホテル) | 2,100 | 367,500 | 1泊平均300CHF |
| **小計** | **2,100** | **367,500** | |
| **その他** | | | |
...
**調整後総額**: 7,000 CHF (1,225,000 JPY) - **予算内65,000 JPY節約**
